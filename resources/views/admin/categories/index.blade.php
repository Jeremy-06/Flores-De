...
<div class="fd-container py-4 md:py-6">
    ...
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-3xl font-bold" style="font-family: 'Playfair Display', serif;">Manage Categories</h1>
        <a href="{{ route('admin.categories.create') }}" class="fd-btn-primary text-sm">
            + Add Category
        </a>
    </div>
