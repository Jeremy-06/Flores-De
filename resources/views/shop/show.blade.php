...
<div class="max-w-6xl mx-auto px-4 py-8">
    ...
    <div class="bg-white border border-gray-200 rounded overflow-hidden">
        <div class="lg:flex">
            ...
            <div class="lg:w-1/2">
                @if($flower->image)
                    <img src="{{ asset('storage/' . $flower->image) }}" alt="{{ $flower->name }}" class="w-full h-[400px] lg:h-full object-cover">
                @else
                    <div class="w-full h-[400px] lg:h-full bg-gray-100 flex items-center justify-center">
