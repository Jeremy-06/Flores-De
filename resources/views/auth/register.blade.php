<x-guest-layout>
    ...
    <div class="text-center mb-6">
        <h2 class="text-2xl font-display font-bold text-gray-800">Create Account</h2>
        <p class="text-gray-400 text-sm mt-1">Join us and start ordering beautiful flowers</p>
    </div>
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="text-center mt-6">
            <p class="text-sm text-gray-400">
                ...
                <a href="{{ route('login') }}" class="text-rose-500 hover:text-rose-600 font-semibold transition-colors">Sign In</a>
            </p>
        </div>
    </form>
</x-guest-layout>
